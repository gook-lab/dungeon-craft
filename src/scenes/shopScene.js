...
export const SHOPS = {
  ...
  smith: { // 대장장이 — weapons + armor (+ 강화)
    ...
    stock: [
      ...
      'stone_maul', 'storm_crossbow', 'blessed_flail', 'gale_bow', // 원소 무기(물리 상성) — umbral_dagger는 처단 루트 전용이라 상점 제외
      'vampiric_blade', 'thornmail', // 특색 장비(흡혈/가시)
  ...
  witchs_hut_shop: { // 마녀의 오두막 — mercy route exclusive shop (독/암흑 테마)
    title: '마녀의 선물',
    stock: [
      'herb', 'antidote', 'mana_drop', 'return_scroll',
      'venom_fang', 'assassin_dagger',            // 독·암살 무기
      'antitoxin_charm', 'thorn_band', 'regen_ring', 'sage_amulet', // 독·재생·주술 장신구
    ],
  },
};
